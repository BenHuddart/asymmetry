...
groups, hydrides, water of crystallization. The fitted :math:`r_{\mu H}` is
...
the dipolar interaction to a single **localized** electronic moment at
...
The same spin-½ pair polarization parameterised by the **dipolar field** at
...
form. The polarization is computed numerically: the full three-spin dipolar
...
The collinear F–μ–F polarization dynamicized by the strong-collision model at
