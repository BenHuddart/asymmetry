...
- The **preset grouping** dropdown offers instrument-aware layouts. For
  ...
  :doc:`/user_guide/vector_polarization`).
...
:doc:`/user_guide/detector_grouping` for the full reference.
...
- :doc:`/user_guide/detector_grouping` — full grouping and layout-editor
  reference.
