...
- :doc:`/user_guide/loading_data` — load formats.
- :doc:`/user_guide/detector_grouping` — group definitions.
- :doc:`/user_guide/fit_wizard` — the model-recommendation tool.
- :doc:`/user_guide/parameter_trending` — the trend panel.
- :doc:`/user_guide/composite_models` — combining oscillatory and
