...
:math:`\nu`. In the strong-collision dynamic KT (Hayano *et al.*,
Phys. Rev. B **20**, 850 (1979)) increasing :math:`\nu` washes out the
KT minimum and, once
...
:doc:`/reference/parameter_trending` and the batch playbook in
...
- :doc:`/reference/fit_functions/kubo_toyabe` — full DynamicGaussianKT
  reference and its relation to the Keren and static-KT models.
- :doc:`/reference/fit_functions/kubo_toyabe` — the static limit used to fix
  :math:`\Delta`.
