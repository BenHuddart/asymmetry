...
| D8 | Variable-bin law | width = bin0·exp(λ_μ·0.22·ln(r)·t), i.e. ≈ (r)^(t/10 μs) with r = bin10/bin0 (exponent off by ×1.0014) | Exact width = bin0·(bin10/bin0)^(t/10 μs); same knobs, same intent | cosmetic exactness (widths differ < 0.2% at 10 µs, < 0.6% by 32 µs) |
